...
class ApiDataService:
    ...
    def get_data(self, dataType):
        ...
        try:
            ...
            curs = self.conn.cursor()
            sql1 = f'''INSERT INTO Organization (Organization_name, Organization_address, district_id,GeoData,Object_Tpe,GlobalID) VALUES (%s,%s,%s,%s,%s,%s);'''
            for obj in data or []:
                cell = obj['Cells']
